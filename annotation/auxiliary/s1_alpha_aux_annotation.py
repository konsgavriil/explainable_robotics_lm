...
class S1AlphaAUXAnnotator:
    ...
    def save_dataset(self):
        self.data.to_csv('persistance/moos_ivp_csv/s1_alpha_dataset_modified_contrastive.csv', index=False)


a = S1AlphaAUXAnnotator("persistance/moos_ivp_csv/s1_alpha_dataset_modified_cf.csv")
