...
class S4AUXAnnotator:
    ...
    def __init__(self, path):
        ...
        print("Done")
        self.dataset = pd.read_csv("persistance/moos_ivp_csv/s4_delta_sm_training.csv")
    ...
    def save_dataset(self):
        self.data.to_csv('persistance/moos_ivp_csv/s4_delta_dataset_modified_contrastive_v2.csv', index=False)


a = S4AUXAnnotator("persistance/moos_ivp_csv/s4_delta_dataset_modified_contrastive.csv")
