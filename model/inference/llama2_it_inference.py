...
for index, row in df2.iterrows(): 
    ...
    response = inf_pipeline(text, return_full_text=False)
...
wandb.init(project=WANDB_PROJECT, name="llama2_it_causal_inference")
# wandb.init(project="xarlm_llama2", name="llama2_it_cf_inference")
