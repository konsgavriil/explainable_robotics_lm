...
unique_pad_token = "<pad>"
if unique_pad_token not in tokenizer.vocab:
    tokenizer.add_tokens([unique_pad_token])

# Step 3: Set the unique PAD token as the pad token
tokenizer.pad_token = unique_pad_token
